    ...
    public partial class FrmPermissionList : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (detail.PermissionID == 0)
                ...
                MessageBox.Show("You can not update a approved o disapproved permission");
            else 
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (rbStartDate.Checked)
                list = list.Where(x => x.StartDate < Convert.ToDateTime(dpFinish.Value) && x.StartDate > Convert.ToDateTime(dpStart.Value)).ToList();
            else if (rbEndDate.Checked)
                list = list.Where(x => x.EndDate < Convert.ToDateTime(dpFinish.Value) && x.EndDate > Convert.ToDateTime(dpStart.Value)).ToList();
